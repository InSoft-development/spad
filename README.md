...
_spa_сonn log - запрос логов самого сервера spad (запросы, запуски вокрфлоу и т.д.)
проект логов не имеет (но предполагая один сервер - один проект - логи сервераи есть логи проекта в каком-то плане)
